...
BADGE_COL  = "#c9b8ff"
FILL_COL   = "rgba(192,132,252,0.15)"
...
bx = [nearest_row(d)[0] for d, _ in buy_events]
by = [nearest_row(d)[1] for d, _ in buy_events]
bl = [l for _, l in buy_events]
...
fig.update_layout(
    ...
    xaxis=dict(
        ...
        rangeselector=dict(
            ...
            activecolor="rgba(192,132,252,0.35)",
